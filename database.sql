...
VALUES
(1, 'Company X', 'Great Event', 'John', 'Doe', 'john.doe@example.com', '123-456-7890', 'http://example.com', 'Sports', TRUE, '10:00:00', '14:00:00', 1, 2, 'Gym', 'High', 'Weekends', '2024-11-12', '2024-11-15', 'None', '150', 'Yes', 'High School', '/path/to/team.pdf', TRUE, 'Jane', 'Smith', '123 Main St', 'Springfield', 'IL', '62704', '123-456-7890', 'jane.smith@example.com', TRUE, 1)
